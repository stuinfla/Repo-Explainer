...
**P1 — One brain, one source of truth.** A single Claude Code **Skill** (`skills/explainmyrepo/SKILL.md`)
...
| Term | Definition |
|------|------------|
| **Brain** | The single Claude Code Skill (`skills/explainmyrepo/SKILL.md`) that holds all judgment. The one source of truth; every adapter runs it. |
...
1. **Plugin (BUILD FIRST).** `.claude-plugin/plugin.json` + `commands/explainmyrepo.md` +
   `skills/explainmyrepo/SKILL.md` (the Brain) + `tools/*` (pure tools) +
...
commands/explainmyrepo.md
skills/explainmyrepo/SKILL.md          ← THE BRAIN (one source of truth)
